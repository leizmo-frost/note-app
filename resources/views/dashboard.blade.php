            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden">
                <div class="p-6 text-gray-800 dark:text-gray-100">
                    ...
                    <div id="tasks" class="mt-8">
                        ...
                        <div class="mt-6">
                            <input type="text" id="new-task" class="w-full p-3 border rounded-lg bg-yellow-200 text-yellow-800 placeholder-gray-500 dark:bg-yellow-700 dark:text-yellow-200" placeholder="Add a new task">
